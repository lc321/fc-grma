...
def get_command_line_parser():
    ...
    parser.add_argument('-batch_size_base', type=int, default=50)
    ...
    parser.add_argument('-episode_way', type=int, default=6)
    parser.add_argument('-episode_query', type=int, default=15)
    parser.add_argument('-inc_episode', type=int, default=1)

    # for cec
    parser.add_argument('-lrg1', type=float, default=0.0001) #lr for graph attention network
    parser.add_argument('-lrg2', type=float, default=0.0001)
    parser.add_argument('-low_shot', type=int, default=5)
    parser.add_argument('-low_way', type=int, default=1)

    parser.add_argument('-start_session', type=int, default=0)
    parser.add_argument('-model_dir', type=str, default=MODEL_DIR, help='loading model parameter from a specific dir')
    parser.add_argument('-save_path', type=str, default=SAVE_DIR, help='Saving model to a specific dir')
